...
if (updatePasswordForm) {
  updatePasswordForm.addEventListener("submit", function (e) {
    e.preventDefault();
    var passwordCurrent = updatePasswordForm.querySelector(".current-pass").value;
    var password = updatePasswordForm.querySelector(".new-pass").value;
    var passwordConfirm = updatePasswordForm.querySelector(".new-pass-confirm").value;
    console.log(passwordCurrent, password, passwordConfirm);
    (0, _uppdateSetting.uppdatePassword)(passwordCurrent, password, passwordConfirm);
  });
}
if (signUpForm) {

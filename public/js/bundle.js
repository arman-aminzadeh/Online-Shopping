        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === "success") {
              ...
              (0, _alert.showAlert)("error", "Incorrect username or password!");
            }
            _context.next = 11;
            break;
          case 8:
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"signUpUser.js":[function(require,module,exports) {
"use strict";
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"imageChange.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.imageChanger = void 0;
//console.log(mainImage, smallPic);
var imageChanger = function imageChanger(smallPic, mainImage) {
  console.log("Hello....");
  smallPic[0].addEventListener("click", function () {
    mainImage.src = smallPic[0].src;
  });
  smallPic[1].addEventListener("click", function () {
    mainImage.src = smallPic[1].src;
  });
  smallPic[2].addEventListener("click", function () {
    mainImage.src = smallPic[2].src;
  });
  smallPic[3].addEventListener("click", function () {
    mainImage.src = smallPic[3].src;
  });
};
exports.imageChanger = imageChanger;
},{}],"uppdateSetting.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.uppdatePassword = exports.uppdateData = void 0;
var _axios = _interopRequireDefault(require("axios"));
var _alert = require("./alert");
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
var uppdateData = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 9:
            ...
            (0, _alert.showAlert)("error", "Faild to updated!");
          case 12:
          case "end":
            return _context.stop();
        }
  ...
  return function uppdateData(_x) {
    return _ref.apply(this, arguments);
  };
}();
exports.uppdateData = uppdateData;
var uppdatePassword = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(passwordCurrent, password, confirmPassword) {
    var res;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
  ...
  return function uppdatePassword(_x2, _x3, _x4) {
    return _ref2.apply(this, arguments);
  };
}();
exports.uppdatePassword = uppdatePassword;
...
var submitReview = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(review) {
    var currentUrl, res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            currentUrl = window.location.protocol + "//" + window.location.host + "/api/v1" + window.location.pathname;
            console.log(currentUrl);
            _context.prev = 2;
            _context.next = 5;
            return (0, _axios.default)({
              method: "POST",
              url: "".concat(currentUrl, "/reviews "),
              data: {
                review: review
              }
            });
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return (0, _axios.default)("http://localhost:3000/api/v1/bookings/checkout-session/".concat(productId));
          case 3:
...
var _imageChange = require("./imageChange");
var _uppdateSetting = require("./uppdateSetting");
...
var updatePasswordForm = document.querySelector(".user-pass-update");
var reviewForm = document.querySelector(".review-form");
var signUpForm = document.querySelector(".sign-up-form");
var buyProductBtn = document.querySelector(".buy-btn");
...
if (userUpdateData) {
  userUpdateData.addEventListener("submit", function (e) {
    e.preventDefault();
    ...
    console.log(form);
    (0, _uppdateSetting.uppdateData)(form);
  });
}
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              e.preventDefault();
              passwordCurrent = updatePasswordForm.currentPassword.value;
              password = updatePasswordForm.newPassword.value;
              confirmPassword = updatePasswordForm.newPasswordConfirm.value;
              _context.next = 6;
              return (0, _uppdateSetting.uppdatePassword)(passwordCurrent, password, confirmPassword);
            case 6:
              updatePasswordForm.currentPassword.value = "", updatePasswordForm.newPassword.value = "", updatePasswordForm.newPasswordConfirm.value = "";
            case 7:
            case "end":
              return _context.stop();
          }
